...
#define STRING_CONFIG_H_AUTHOR "powertomato" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //Anet A8, E3D Volcano, 100% fan
  #define DEFAULT_Kp 23.91 
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 91.66 }
...
#define X_MIN_POS -15 //-36 original extruder
#define Y_MIN_POS -9 //-14                   
#define Z_MIN_POS 0
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEFT_PROBE_BED_POSITION   MAX( X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER, GRID_CLEARANCE)
  #define RIGHT_PROBE_BED_POSITION  MIN( X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER, X_BED_SIZE-GRID_CLEARANCE )
  #define FRONT_PROBE_BED_POSITION  MAX( Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER, GRID_CLEARANCE )
  #define BACK_PROBE_BED_POSITION   MIN( Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER, Y_BED_SIZE-GRID_CLEARANCE )
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER) 
  #define Z_SAFE_HOMING_Y_POINT (10)                                       
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (100*60)
#define HOMING_FEEDRATE_Z  (5*30) //(2.5*60)
